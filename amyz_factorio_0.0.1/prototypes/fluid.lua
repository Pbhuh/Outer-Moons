...
{
  {
    ...
    subgroup = "fluid",
    order = "b[new-fluid]-f[aquilo]-a[ammoniacal-solution]",
  ...
  },
  {
    ...
    order = "b[new-fluid]-f[aquilo]-b[ammonia]",
  ...
  },
  {
    ...
    subgroup = "fluid",
    order = "b[new-fluid]-f[aquilo]-c[fluorine]",
  ...
  },
  {
    ...
    subgroup = "fluid",
    order = "b[new-fluid]-f[aquilo]-e[fluoroketone-cold]",
  ...
  },
  {
    ...
    subgroup = "fluid",
    order = "b[new-fluid]-f[aquilo]-d[fluoroketone-hot]",
  ...
  },
  {
    ...
    subgroup = "fluid",
    order = "b[new-fluid]-f[aquilo]-f[lithium-brine]",
    default_temperature = 15,
    heat_capacity = "0.1kJ",
  ...
  },
  {
    ...
    subgroup = "fluid",
    order = "b[new-fluid]-f[aquilo]-g[fusion-plasma]",
  ...
  -- AMYZ
  {
    ...
    subgroup = "fluid",
    order = "b[new-fluid]-e[selene]-a[chlorine]",
    default_temperature = 25,
	gas_temperature = -35,
    heat_capacity = "0.1kJ",
