data:extend(
{
  ...
  },
  {
    ...
    subgroup = "fluid",
    order = "b[new-fluid]-e[fulgora]-a[holmium-solution]",
  ...
  },
  {
    ...
    subgroup = "fluid",
    order = "b[new-fluid]-e[fulgora]-b[electrolyte]",
    default_temperature = 15,
    max_temperature = 500,
    heat_capacity = "0.01kJ",
  ...
  
  {
    type = "fluid",
    name = "saline",
    icon = "__amyz_factorio__/graphics/icons/fluid/saline.png",
    subgroup = "fluid",
    order = "b[new-fluid]-e[selene]-a[saline]",
    default_temperature = 25,
	gas_temperature = 100,
    heat_capacity = "0.1kJ",
  ...
  },
  {
    type = "fluid",
    name = "chlorine",
    icon = "__amyz_factorio__/graphics/icons/fluid/chlorine.png",
    subgroup = "fluid",
    order = "b[new-fluid]-e[selene]-b[chlorine]",
    default_temperature = 25,
	gas_temperature = -35,
    heat_capacity = "0.1kJ",
  ...
  },
  {
    ...
    icon = "__amyz_factorio__/graphics/icons/fluid/saline.png",
    subgroup = "fluid",
    order = "b[new-fluid]-e[selene]-c[saline]",
    default_temperature = 25,
	gas_temperature = 100,
    heat_capacity = "0.1kJ",
    base_color = {0.52, 0.58, 0.69},
