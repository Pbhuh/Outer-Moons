...
local function resource(resource_parameters, autoplace_parameters)
  return
  {
    ...
    icon = "__amyz_factorio__/graphics/icons/" .. resource_parameters.name .. ".png",
    ...
    stages =
    {
      sheet =
      {
        filename = "__amyz_factorio__/graphics/entity/" .. resource_parameters.name .. "/" .. resource_parameters.name .. ".png",
        priority = "extra-high",
        size = 128,
        frame_count = 8,
        variation_count = 8,
  ...
  -- "d" is available for another resource, but isn't used for now.
   ...
   resource(
	...
	),
	{
		...
		icon = "__amyz_factorio__/graphics/icons/chlorine-geyser.png",
		flags = {"placeable-neutral"},
		...
		stages =
		{
		  layers =
		  {
			util.sprite_load("__amyz_factorio__/graphics/entity/chlorine-geyser/chlorine-geyser",
			{
			  priority = "high",
			  frame_count = 4,
			  scale = 0.5,
    ...
    type = "resource",
    name = "saline-geyser",
    icon = "__amyz_factorio__/graphics/icons/saline-geyser.png",
    flags = {"placeable-neutral"},
    category = "basic-fluid",
    subgroup = "mineable-fluids",
    order="a-b-a",
    ...
    stages =
    {
      layers =
      {
        util.sprite_load("__amyz_factorio__/graphics/entity/saline-geyser/saline-geyser",
        {
          priority = "extra-high",
          frame_count = 4,
          scale = 0.5
