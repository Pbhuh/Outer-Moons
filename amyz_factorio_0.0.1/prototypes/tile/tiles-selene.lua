...
data:extend
{
  ...
  {
    type = "noise-expression",
    name ="selene_basalts_range",
    expression = "100 * min(selene_basalts_biome * lava_spawn_excluder\z
                            * range_select_base(selene_elev, -5000, 0, 1, -1000, 1),\z
                            100 * (1 - selene_metal_tile))"
  },
  {
    type = "noise-expression",
  ...
  },
  {
    ...
    expression = "selene_basalts_biome * range_select_base(selene_elev, 8, 22, 1, 0, 5)\z
                  + (aux - 0.05)\z
                  + 50000 * selene_metal_tile"
  },
  {
    type = "noise-expression",
    name = "volcanic_cracks_cold_range",
    expression = "(0.5 - selene_ashlands_biome) * range_select_base(selene_elev, 20, 100, 1, 0, 1)\z
                  + (aux - 0.3)"
  },
  {
    type = "noise-expression",
  ...
  -- High aux high moisture is rocks with pita
  {
    ...
    expression = "2 * (selene_ashlands_biome - 0.5)\z
                  - 1.5 * (aux - 0.25)\z
                  - 1.5 * (moisture - 0.6)"
  },
  {
  ...
  },
  {
    ...
    expression = "min(1, 4 * (selene_ashlands_biome - 0.25))\z
                  + max(-1.5 * (aux - 0.25),\z
  ...
  },
  {
    ...
    expression = "2 * (selene_ashlands_biome - 0.5)"
  },
  {
    type = "noise-expression",
  ...
  -- COMBINE SHARED
  {
    ...
    expression = "max(volcanic_soil_light_range_mountains, volcanic_soil_light_range_ashlands, 10 * (selene_chlorine_region_patchy + 0.2))"
  },
  {
    type = "noise-expression",
  ...
  ----------- SULFUR OCEAN
  {
    ...
    autoplace = {probability_expression = "selene_basalts_range"},
    layer = 3,
    layer_group = "water",
    ...
    variants = tile_variations_template_with_transitions(
      "__amyz_factorio__/graphics/terrain/sulfur-ocean.png",
      {
        max_size = 4,
        [1] = { weights = {0.085, 0.085, 0.085, 0.085, 0.087, 0.085, 0.065, 0.085, 0.045, 0.045, 0.045, 0.045, 0.005, 0.025, 0.045, 0.045 } },
        [2] = { probability = 1, weights = {0.018, 0.020, 0.015, 0.025, 0.015, 0.020, 0.025, 0.015, 0.025, 0.025, 0.010, 0.025, 0.020, 0.025, 0.025, 0.010 }, },
