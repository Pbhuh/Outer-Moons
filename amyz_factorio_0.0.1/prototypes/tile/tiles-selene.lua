...
data:extend
{
  ...
  {
    type = "noise-expression",
    name ="mountain_cracks_hot_range",
    expression = "selene_basalts_biome * range_select_base(selene_elev, 0, 8, 1, 0, 20)"
  },
  {
    type = "noise-expression",
    name ="mountain_cracks_warm_range",
    expression = "selene_basalts_biome * range_select_base(selene_elev, 8, 22, 1, 0, 5)\z
                  + (aux - 0.05)\z
                  + selene_titanium_tile * selene_aluminum_tile"
  },
  {
    type = "noise-expression",
    name = "mountain_cracks_cold_range",
    expression = "(0.5 - selene_plains_biome) * range_select_base(selene_elev, 20, 100, 1, 0, 1)\z
                  + (aux - 0.3)"
  },
  {
    type = "noise-expression",
    name = "mountain_smooth_stone_warm_range",
    expression = "selene_basalts_biome * range_select_base(selene_elev, 8, 20, 1, 0, 5)\z
                  - (aux - 0.05)\z
                  + selene_titanium_tile * selene_aluminum_tile"
  },
  {
    type = "noise-expression",
    name = "mountain_smooth_stone_range",
    expression = "(0.5 - selene_plains_biome) * range_select_base(selene_elev, 20, 100, 1, 0, 1)\z
                  - (aux - 0.3)"
  },
  ...
  {
    type = "noise-expression",
    name = "mountain_folds_flat_range",
    expression = "2 * (selene_mountains_biome - 0.5) - 0.15 * mountain_volcano_spots"
  },
  {
    type = "noise-expression",
    name = "mountain_folds_range",
    expression = "2 * (selene_mountains_biome - 0.5) + (aux - 0.5) + 0.5 * (mountain_volcano_spots - 0.1)"

  },
  {
    type = "noise-expression",
    name = "mountain_folds_warm_range",
    expression = "2 * (selene_mountains_biome - 0.5) + 3 * (mountain_volcano_spots - 0.85) - 2 * (aux - 0.5)"
  },
  {
    type = "noise-expression",
    name ="mountain_jagged_ground_range",
    -- volcano peak circle is expected to be 1020 to 1030, The cliff is at 1020
    expression = "5 * min(10, max(selene_mountains_biome + 0.2,\z
                                  range_select_base(selene_elev, 1010, 2000, 2, -10, 1) + 3 * (aux - 0.5)))"
  },
  {
    type = "noise-expression",
    name ="mountain_soil_light_range_mountains",
    expression = "min(0.8, 4 * (selene_mountains_biome - 0.25)) - 0.35 * mountain_volcano_spots - 3 * (aux - 0.2)"
  },
  {
    type = "noise-expression",
    name ="mountain_soil_dark_range_mountains",
    expression = "min(0.8, 4 * (selene_mountains_biome - 0.25)) - 0.35 * mountain_volcano_spots - 1 * (aux - 0.5)"
  },
  ...
  {
    type = "noise-expression",
    name = "mountain_plains_range",
    expression = "2 * (selene_plains_biome - 0.5)\z
                  - 1.5 * (aux - 0.25)\z
                  - 1.5 * (moisture - 0.6)"
  },
  {
    type = "noise-expression",
    name = "mountain_plains_light_range",
    expression = "2 * (selene_plains_biome - 0.5)\z
                  - 1.5 * (moisture - 0.6)"
  },
  {
    type = "noise-expression",
    name = "mountain_plains_dark_range",
    expression = "min(1, 4 * (selene_plains_biome - 0.25))\z
                  + max(-1.5 * (aux - 0.25),\z
  ...
  {
    type = "noise-expression",
    name = "mountain_pumice_stones_range",
    expression = "2 * (selene_plains_biome - 0.5)\z
                  + 1.5 * (aux - 0.5)\z
                  + 1.5 * (moisture - 0.66)"
  },
  {
    type = "noise-expression",
    name = "mountain_ash_cracks_range",
    expression = "min(1, 4 * (selene_plains_biome - 0.25))\z
                  + 1.5 * (aux - 0.5)\z
                  - 1.5 * (moisture - 0.66)"
  },
  {
    type = "noise-expression",
    name = "mountain_ash_soil_range",
    expression = "2 * (selene_plains_biome - 0.5)"
  },
  {
    type = "noise-expression",
    name = "mountain_soil_light_range_plains",
    expression = "2 * (selene_plains_biome - 0.5)\z
                  + 1.5 * (moisture - 0.8)"
  },
  {
    type = "noise-expression",
    name = "mountain_soil_dark_range_plains",
    expression = "2 * (selene_plains_biome - 0.5)\z
                  - 1.5 * (aux - 0.25)\z
                  + 1.5 * (moisture - 0.8)"
  },
  ...
  {
    type = "noise-expression",
    name = "mountain_soil_light_range",
    expression = "max(mountain_soil_light_range_mountains, mountain_soil_light_range_plains, 10 * (selene_saline_region_patchy + 0.2))"
  },
  {
    type = "noise-expression",
    name = "mountain_soil_dark_range",
    expression = "max(mountain_soil_dark_range_mountains, mountain_soil_dark_range_plains)"
  },
  ----------- CLIFF TILE
  ...
  ----------- GREY DIRT
  {
		...
		autoplace = {
		  probability_expression = "mountain_smooth_stone_warm_range"
		},
		layer = 5,
		...
		variants = tile_variations_template_with_transitions(
		  "__amyz_factorio__/graphics/terrain/mineral-grey-dirt-1.png",
		  {
			max_size = 4,
	...
	},
	{
		...
		collision_mask = tile_collision_masks.ground(),
		autoplace = {
		  probability_expression = "mountain_ash_cracks_range"
		},
		layer = 6,
		...
		sprite_usage_surface = "space",
		variants = tile_variations_template_with_transitions(
		  "__amyz_factorio__/graphics/terrain/mineral-grey-dirt-2.png",
		  {
			max_size = 4,
			[1] = { weights = {0.085, 0.085, 0.085, 0.085, 0.087, 0.085, 0.065, 0.085, 0.045, 0.045, 0.045, 0.045, 0.005, 0.025, 0.045, 0.045 } },
			[2] = { probability = 1, weights = {0.018, 0.020, 0.015, 0.025, 0.015, 0.020, 0.025, 0.015, 0.025, 0.025, 0.010, 0.025, 0.020, 0.025, 0.025, 0.010 }, },
	...
	},
	{
		...
		collision_mask = tile_collision_masks.ground(),
		autoplace = {
		  probability_expression = "mountain_folds_range"
		},
		layer = 6,
		...
		sprite_usage_surface = "space",
		variants = tile_variations_template_with_transitions(
		  "__amyz_factorio__/graphics/terrain/mineral-grey-dirt-3.png",
		  {
			max_size = 4,
			[1] = { weights = {0.085, 0.085, 0.085, 0.085, 0.087, 0.085, 0.065, 0.085, 0.045, 0.045, 0.045, 0.045, 0.005, 0.025, 0.045, 0.045 } },
			[2] = { probability = 1, weights = {0.018, 0.020, 0.015, 0.025, 0.015, 0.020, 0.025, 0.015, 0.025, 0.025, 0.010, 0.025, 0.020, 0.025, 0.025, 0.010 }, },
	...
	},
	{
		...
		collision_mask = tile_collision_masks.ground(),
		autoplace = {
		  probability_expression = "mountain_folds_warm_range"
		},
		layer = 7,
		...
		sprite_usage_surface = "space",
		variants = tile_variations_template_with_transitions(
		  "__amyz_factorio__/graphics/terrain/mineral-grey-dirt-4.png",
		  {
			max_size = 4,
			[1] = { weights = {0.085, 0.085, 0.085, 0.085, 0.087, 0.085, 0.065, 0.085, 0.045, 0.045, 0.045, 0.045, 0.005, 0.025, 0.045, 0.045 } },
			[2] = { probability = 1, weights = {0.018, 0.020, 0.015, 0.025, 0.015, 0.020, 0.025, 0.015, 0.025, 0.025, 0.010, 0.025, 0.020, 0.025, 0.025, 0.010 }, },
	...
	},
	{
		...
		collision_mask = tile_collision_masks.ground(),
		autoplace = {
		  probability_expression = "mountain_soil_dark_range"
		},
		layer = 8,
		map_color={90, 90, 90},
		vehicle_friction_modifier = 4,
		sprite_usage_surface = "space",
		variants = tile_variations_template_with_transitions(
		  "__amyz_factorio__/graphics/terrain/mineral-grey-dirt-5.png",
		  {
			max_size = 4,
			[1] = { weights = {0.085, 0.085, 0.085, 0.085, 0.087, 0.085, 0.065, 0.085, 0.045, 0.045, 0.045, 0.045, 0.005, 0.025, 0.045, 0.045 } },
			[2] = { probability = 1, weights = {0.018, 0.020, 0.015, 0.025, 0.015, 0.020, 0.025, 0.015, 0.025, 0.025, 0.010, 0.025, 0.020, 0.025, 0.025, 0.010 }, },
	...
	},
	{
		...
		collision_mask = tile_collision_masks.ground(),
		autoplace = {
		  probability_expression = "mountain_soil_light_range"
		},
		layer = 9,
		...
		sprite_usage_surface = "space",
		variants = tile_variations_template_with_transitions(
		  "__amyz_factorio__/graphics/terrain/mineral-grey-dirt-6.png",
		  {
			max_size = 4,
			[1] = { weights = {0.085, 0.085, 0.085, 0.085, 0.087, 0.085, 0.065, 0.085, 0.045, 0.045, 0.045, 0.045, 0.005, 0.025, 0.045, 0.045 } },
			[2] = { probability = 1, weights = {0.018, 0.020, 0.015, 0.025, 0.015, 0.020, 0.025, 0.015, 0.025, 0.025, 0.010, 0.025, 0.020, 0.025, 0.025, 0.010 }, },
	...
	},
	{
		...
		collision_mask = tile_collision_masks.ground(),
		autoplace = {
		  probability_expression = "mountain_cracks_hot_range"
		},
		layer = 10,
		map_color={60, 60, 60},
		vehicle_friction_modifier = 4,
		sprite_usage_surface = "space",
		variants = tile_variations_template_with_transitions(
		  "__amyz_factorio__/graphics/terrain/mineral-grey-sand-1.png",
		  {
			max_size = 4,
			[1] = { weights = {0.085, 0.085, 0.085, 0.085, 0.087, 0.085, 0.065, 0.085, 0.045, 0.045, 0.045, 0.045, 0.005, 0.025, 0.045, 0.045 } },
			[2] = { probability = 1, weights = {0.018, 0.020, 0.015, 0.025, 0.015, 0.020, 0.025, 0.015, 0.025, 0.025, 0.010, 0.025, 0.020, 0.025, 0.025, 0.010 }, },
	...
	},
	{
		...
		collision_mask = tile_collision_masks.ground(),
		autoplace = {
		  probability_expression = "mountain_cracks_warm_range"
		},
		layer = 11,
		map_color={80, 80, 80},
		vehicle_friction_modifier = 4,
	...
	},
	{
		...
		collision_mask = tile_collision_masks.ground(),
		autoplace = {
		  probability_expression = "mountain_cracks_cold_range"
		},
		layer = 12,
