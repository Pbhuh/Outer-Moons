...
tintable_rock_tint = combine_tint(mefitis_base_tint, tintable_rock_tint)
titanium_rock_tint = combine_tint(mefitis_base_tint, titanium_rock_tint)
...
function chimney_sulfuric_stateless_visualisation(position)
  return
  {
    -- expanded 2 animation layers into 2 visualisations to demo multiple visualisations
    {
      ...
      animation =
      {
        filename = "__amyz_factorio__/graphics/entity/chlorine-geyser/chlorine-geyser-gas-outer.png",
        frame_count = 47,
        line_length = 16,
        width = 90,
        height = 188,
    ...
    },
    {
      ...
      animation =
      {
         filename = "__amyz_factorio__/graphics/entity/chlorine-geyser/chlorine-geyser-gas-inner.png",
         frame_count = 47,
         line_length = 16,
         width = 40,
         height = 84,
...
data:extend{
  ...
  --- Chlorine STAINS
  {
    ...
    pictures = get_decal_pictures("__amyz_factorio__/graphics/decorative/chlorine-stain/chlorine-stain-", "", 512,13)
  },
  --- SPOTTY chlorine STAINS
  {
    ...
    pictures = get_decal_pictures("__amyz_factorio__/graphics/decorative/chlorine-stain/chlorine-stain-spotty-", "", 512, 21)
  },
  --- chlorine-PUDDLE
  {
    ...
    pictures = get_decal_pictures("__amyz_factorio__/graphics/decorative/chlorine-puddle/chlorine-puddle-", "", 384, 8)
  },
  --- chlorine-PUDDLE-SMALL
  {
    ...
    pictures = get_decal_pictures("__amyz_factorio__/graphics/decorative/chlorine-puddle/chlorine-puddle-small-", "", 192, 4)
  },
  --- SMALL CRATERS
  {
    name = "crater-small",
  ...
  --- ROCK CLUSTERS
  {
    ...
    autoplace =
    {
      ...
      placement_density = 2,
      probability_expression = "mefitis_rock_cluster"
    },
