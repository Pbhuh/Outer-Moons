...
local function asteroid_variation(asteroid_type, suffix, scale, size)
  ...
  {
    color_texture = {
      filename = "__outer_moons__/graphics/entity/asteroid/".. asteroid_type .."/"..asteroid_sizes[size].."/".."asteroid-" .. asteroid_type .. "-" .. asteroid_sizes[size] .. "-colour-" .. suffix .. ".png",
...
for asteroid_size, asteroid_size_name in pairs(asteroid_sizes) do
  for asteroid_type, asteroid_data in pairs(asteroids_data) do
    ...
    local variations ={}
    if (asteroid_type == "silicaceous") then
      if (asteroid_size_name == "chunk") then
    ...
    data:extend({
      {
        ...
        icon = "__outer_moons__/graphics/icons/"..asteroid_name..".png",
        icon_size = 64,
...
data.raw["asteroid-chunk"]["silicaceous-asteroid-chunk"].graphics_set.lights[2] = { color = {0.55,0.85,0.85}, direction = {-1,-45,0.1} }
